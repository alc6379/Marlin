...
#define STRING_CONFIG_H_AUTHOR "(Rooster, Ender-3)" // Who made the changes.
//#define CUSTOM_VERSION_FILE Version.h // Path from the root directory (no quotes)

#define STRING_SPLASH_LINE1 "bugfix-2.0.x" // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "my shit is custom"         // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "Tangerine"
